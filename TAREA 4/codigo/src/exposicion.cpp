...
bool sonExposicionesCompatibles(TExposicion exp1, TExposicion exp2){ 
    if(exp1 != NULL && exp2 != NULL){
        ...
        //3er caso, se cruzan algun dia
            ...
            // si se cruzan verifico si utilizan las mismas piezas viendo la interseccion
            ...
            // libero memoria solicitada en interseccion
            liberarTConjuntoPiezas(interseccion);
            // si la interseccion es vacia son compatibles
            return cant == 0;
        }
    }else{
        return false;
