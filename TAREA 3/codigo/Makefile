...
ENTREGAR = visitaDia conjuntoPiezas exposicion listaExposiciones galeria 

MODULOS = $(ENTREGAR) fecha utils pieza visitante coleccionPiezas grupoABB coleccionTGrupos
...
# casos de prueba
CASOS = visitaDia1-crear-insertar-imprimir-liberar \
